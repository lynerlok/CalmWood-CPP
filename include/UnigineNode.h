...
public:
	...
	void updateEnabled();
	static void *addCallback(Node::CALLBACK_INDEX callback, Unigine::CallbackBase2< Ptr<Node>, Ptr<Property> > *func);
	static void *addCallback(Node::CALLBACK_INDEX callback, Unigine::CallbackBase3< Ptr<Node>, Ptr<Property>, int > *func);
	static void *addCallback(Node::CALLBACK_INDEX callback, Unigine::CallbackBase3< Ptr<Node>, int, int > *func);
	static void *addCallback(Node::CALLBACK_INDEX callback, Unigine::CallbackBase2< Ptr<Node>, Ptr<Node> > *func);
	static void *addCallback(Node::CALLBACK_INDEX callback, Unigine::CallbackBase2< Ptr<Node>, int > *func);
	static void *addCallback(Node::CALLBACK_INDEX callback, Unigine::CallbackBase1< Ptr<Node> > *func);

...
public:
	...
	void *addCallback(Property::CALLBACK_INDEX callback, Unigine::CallbackBase1< Ptr<Property> > *func);
	void *addCallback(Property::CALLBACK_INDEX callback, Unigine::CallbackBase2< Ptr<Property>, int > *func);
...
public:
	...
	static void *addCallback(Properties::CALLBACK_INDEX callback, Unigine::CallbackBase1< Ptr<Property> > *func);

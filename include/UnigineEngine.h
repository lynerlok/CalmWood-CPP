...
public:
	...
	/// Returns last system message of the current frame, or empty string if there are no messages.
	virtual String getMessage() const = 0;

	/// Displays dialog displaying value of getMessage().
	virtual void dialogMessage(const char *title) = 0;

	/// Returns system error message of the current frame, or empty string if there are no error messages.
	virtual String getError() = 0;

	/// Displays dialog displaying value of getError().
	virtual void dialogError(const char *title) = 0;

...
public:
	...
	void *addPointAddedCallback(Unigine::CallbackBase2< Ptr<WorldSplineGraph>, Ptr<SplinePoint> > *func);
	bool removePointAddedCallback(void *id);
	void clearPointAddedCallbacks();
	void *addPointChangedCallback(Unigine::CallbackBase2< Ptr<WorldSplineGraph>, Ptr<SplinePoint> > *func);
	bool removePointChangedCallback(void *id);
	void clearPointChangedCallbacks();
	void *addPointRemovedCallback(Unigine::CallbackBase2< Ptr<WorldSplineGraph>, Ptr<SplinePoint> > *func);
	bool removePointRemovedCallback(void *id);
	void clearPointRemovedCallbacks();
	void *addSegmentAddedCallback(Unigine::CallbackBase2< Ptr<WorldSplineGraph>, Ptr<SplineSegment> > *func);
	bool removeSegmentAddedCallback(void *id);
	void clearSegmentAddedCallbacks();
	void *addSegmentChangedCallback(Unigine::CallbackBase2< Ptr<WorldSplineGraph>, Ptr<SplineSegment> > *func);
	bool removeSegmentChangedCallback(void *id);
	void clearSegmentChangedCallbacks();
	void *addSegmentRemovedCallback(Unigine::CallbackBase2< Ptr<WorldSplineGraph>, Ptr<SplineSegment> > *func);
	bool removeSegmentRemovedCallback(void *id);
	void clearSegmentRemovedCallbacks();
	void *addRebuildingFinishedCallback(Unigine::CallbackBase1< Ptr<WorldSplineGraph> > *func);
